...
| claude-signals-v0 | `/Users/jimmygu/the_counselor-signals-v0-phase-b` | `claude/feat/signals-v0-phase-b-cron-email` | (this commit) | paused awaiting PR #88 review — Stage 8 v0 Phase B (daily cron + email alerts). Phase A worktree (`-signals-v0`) is dormant; remove when convenient. |
