...
### 11. `:bind::type` Postgres casts in SQLAlchemy `text()` silently fail
...
### 12. Async route handlers must not hold DB sessions across long awaits

The 2026-05-26 Railway pool exhaustion was *triggered* by trap #11 above
