...
async def chat_strategy(payload: StrategyChatRequest) -> StrategyChatResponse:
    return await parse_strategy_message(payload.user_message, payload.previous_strategy_json, locale=payload.locale)
...
async def parse_markdown_strategy(
    ...
    return await parse_strategy_markdown(payload.markdown_content, payload.document_name, locale=payload.locale)
