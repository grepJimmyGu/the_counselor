...
app.include_router(legal_router)  # §11 disclaimer, single source
...
# PRD-25 — unified signal card. Always mounted: a read-only re-presentation of
# existing signal state, it's the cross-surface brick the redesign renders on
